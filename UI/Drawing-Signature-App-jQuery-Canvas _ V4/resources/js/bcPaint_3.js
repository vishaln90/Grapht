	...
	**/
	var isDragged		= false,
		...
		templates 		= {
							...
							color 			: $('<div id="bcPaint-palette-color3" class="bcPaint-palette-color"></div>'),
							...
							buttonReset 	: $('<button id="bcPaint-reset3" class="bcPaint-reset">Reset</button>'),
							buttonSave		: $('<button id="bcPaint-export3" class="bcPaint-export">Export</button>')
	...
	$.fn.bcPaint3 = function (options) {
		...
		return this.each(function () {
			...
			$.each(colorSet.colors, function (i) {
				...
				color.css('background-color', $.fn.bcPaint3.toHex(colorSet.colors[i]));
			...
			// set color
			$.fn.bcPaint3.setColor(defaultColor);
	...
	$.extend(true, $.fn.bcPaint3, {
		...
		**/
		setColor : function(color){
			paintContext.strokeStyle = $.fn.bcPaint3.toHex(color);
		},
