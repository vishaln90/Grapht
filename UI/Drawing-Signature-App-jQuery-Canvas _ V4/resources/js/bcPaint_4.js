...
(function( $ ) {
	...
	**/
	var isDragged		= false,
		...
		templates 		= {
							...
							color 			: $('<div id="bcPaint-palette-color4" class="bcPaint-palette-color"></div>'),
							...
							buttonReset 	: $('<button id="bcPaint-reset4" class="bcPaint-reset">Reset</button>'),
							buttonSave		: $('<button id="bcPaint-export4" class="bcPaint-export">Export</button>')
	...
	$.fn.bcPaint4 = function (options) {
		...
		return this.each(function () {
			...
			$.each(colorSet.colors, function (i) {
				...
				color.css('background-color', $.fn.bcPaint4.toHex(colorSet.colors[i]));
			...
			// set color
			$.fn.bcPaint4.setColor(defaultColor);
	...
	$.extend(true, $.fn.bcPaint4, {
		...
		**/
		setColor : function(color){
			paintContext.strokeStyle = $.fn.bcPaint4.toHex(color);
		},
	...
	**/
	$.fn.bcPaint4.defaults = {
        ...
        // default color set
        colors : [
					'444444', '999999', 'DDDDDD', '6B0100', 'AD0200',
					'6B5E00'
        ],
