...
$(document).ready(function(){
	...
	$('body').on('click', '#bcPaint1', function(){
		$(this).parent().find("#bcPaint-palette").show();
		$(this).parent().find("#bcPaint-bottom-palette").show();
	});
	...
	**/
	var isDragged		= false,
		...
		templates 		= {
							...
							canvasPane 		: $('<canvas id="bcPaintCanvas" class="bcPaint-functionality"></canvas>'),
							bottom 			: $('<div id="bcPaint-bottom"></div>'),
							buttonReset 	: $('<button id="bcPaint-reset" class="bcPaint-functionality">Reset</button>'),
							buttonSave		: $('<button id="bcPaint-export" class="bcPaint-functionality">Export</button>')
						},
		paintCanvas,
		paintContext;
	...
	**/
	$.fn.bcPaint = function (options) {
		...
		return this.each(function () {
			...
			$("#bcPaint-canvas-container").append(canvasPane);
			$("#bcPaint-bottom-palette").append(buttonReset);
			$("#bcPaint-bottom-palette").append(buttonSave);
