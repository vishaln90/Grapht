...
(function( $ ) {
	...
	**/
	var isDragged		= false,
		...
		templates 		= {
							...
							color 			: $('<div id="bcPaint-palette-color2" class="bcPaint-palette-color"></div>'),
							...
							buttonReset 	: $('<button id="bcPaint-reset2" class="bcPaint-reset">Reset</button>'),
							buttonSave		: $('<button id="bcPaint-export2" class="bcPaint-export">Export</button>')
	...
	**/
	$.fn.bcPaint2 = function (options) {
		...
		$('.bcPaint-image2').css("background-image","url('Pic2.PNG')");
	...
	$.extend(true, $.fn.bcPaint2, {
		...
		**/
		onMouseDown : function(e){
			...
			var button_type = $('.selected_frame').find(".button-type-selected").attr('id');
	...
	**/
	$.fn.bcPaint2.defaults = {
        ...
        // default color set
        colors : [
					'000000', '444444', 'DDDDDD', '6B0100', 'AD0200',
					'6B5E00'
        ],
