(function( $ ) {
	...
	**/
	$.fn.bcPaint4 = function (options) {
		...
		$('.bcPaint-image4').css("background-image","url('Image Storage/Sample2/Lines/Line2.jpg')");
		$('.bcPaint-image4').css("background-size","100% 100%");
	...
	$.extend(true, $.fn.bcPaint4, {
		...
		**/
		onMouseUp : function(e) {
			...
			if (contour_width==0 || contour_height==0) {$.fn.bcPaint4.undo_function();}
