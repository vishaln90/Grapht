(function( $ ) {
	...
	**/
	var isDragged		= false,
		...
		templates 		= {
							...
							color 			: $('<div id="bcPaint-palette-color1" class="bcPaint-palette-color"></div>'),
							...
							buttonReset 	: $('<button id="bcPaint-reset1" class="bcPaint-reset">Reset</button>'),
							buttonSave		: $('<button id="bcPaint-export1" class="bcPaint-export">Export</button>')
	...
	**/
	$.fn.bcPaint1.defaults = {
        ...
        // default color set
        colors : ['000000', '444444', 'DDDDDD', '6B0100', 'AD0200','6B5E00', 'FFE000'],
